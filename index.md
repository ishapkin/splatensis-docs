...
#### Сортировка внутри категории:
  Сортировка осуществляется внутри [списка товаров](http://dev.splatensis.ru/admin/app/product/list).  
  Для того, чтобы изменить позицию товара внутри категории, необходимо выбрать в фильтрах название категории:  
  ![](./img/plist.png){ width=800 }  
  Перетащить за специальный символ строку на нужную позицию, как показано на анимации:    
  ![](./img/psort.gif){ width=1000 }
