...
=======
  Сортировка осуществляется внутри [категории товара](http://dev.splatensis.ru/admin/app/category/3/edit).  
  Для того, чтобы изменить позицию товара внутри категории, необходимо:    
- перейти на вкладку "Товары";
  ![](./img/products-sort.png){ width=800 }  
- переместить посредством `drag&drop` за символ `=` товар на нужную позицию в таблице;  
>>>>>>> release/1.0
- нажать сохранить.
